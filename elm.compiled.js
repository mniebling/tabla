...
Elm.Rhythms = Elm.Rhythms || {};
Elm.Rhythms.make = function (_elm) {
   "use strict";
   _elm.Rhythms = _elm.Rhythms || {};
   if (_elm.Rhythms.values) return _elm.Rhythms.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var kaida1 = {name: "Kaida 1",vibhags: _U.list(["gee ge tee te","gee ge na na","ke ke tee te","gee ge na na"])};
   var teenTalTheka = {name: "Teen Tal Theka",vibhags: _U.list(["dha dhin dhin dha","dha dhin dhin dha","dha tin tin ta","ta dhin dhin dha"])};
   var allRhythms = _U.list([teenTalTheka,kaida1]);
   var Rhythm = F2(function (a,b) {    return {name: a,vibhags: b};});
   return _elm.Rhythms.values = {_op: _op,Rhythm: Rhythm,teenTalTheka: teenTalTheka,kaida1: kaida1,allRhythms: allRhythms};
};
Elm.Tabla = Elm.Tabla || {};
Elm.Tabla.make = function (_elm) {
   "use strict";
   _elm.Tabla = _elm.Tabla || {};
   if (_elm.Tabla.values) return _elm.Tabla.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Rhythms = Elm.Rhythms.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var vibhagToLiElement = function (string) {    return A2($Html.li,_U.list([]),_U.list([$Html.text(string)]));};
   var rhythmToHtml = function (rhythm) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text(rhythm.name)])),A2($Html.ul,_U.list([]),A2($List.map,vibhagToLiElement,rhythm.vibhags))]));
   };
   var rhythmLink = function (rhythm) {
      return A2($Html.li,_U.list([]),_U.list([A2($Html.a,_U.list([$Html$Attributes.href(rhythm.name)]),_U.list([$Html.text(rhythm.name)]))]));
   };
   var listOfRhythmsToHtml = function (listOfRhythms) {    return _U.list([A2($Html.ul,_U.list([]),A2($List.map,rhythmLink,listOfRhythms))]);};
   var view = function (model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("o-container")]),
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("c-rhythm-list")]),listOfRhythmsToHtml(model.possibleRhythms))
              ,A2($Html.div,_U.list([$Html$Attributes.$class("c-rhythm-detail")]),_U.list([rhythmToHtml(model.currentRhythm)]))]));
   };
   var update = F2(function (action,newModel) {    var _p0 = action;return newModel;});
   var NoOp = {ctor: "NoOp"};
   var model = {currentRhythm: $Rhythms.teenTalTheka,possibleRhythms: $Rhythms.allRhythms};
   var main = view(model);
   var Model = F2(function (a,b) {    return {currentRhythm: a,possibleRhythms: b};});
   return _elm.Tabla.values = {_op: _op
                              ,Model: Model
                              ,model: model
                              ,NoOp: NoOp
                              ,update: update
                              ,view: view
                              ,listOfRhythmsToHtml: listOfRhythmsToHtml
                              ,rhythmLink: rhythmLink
                              ,vibhagToLiElement: vibhagToLiElement
                              ,rhythmToHtml: rhythmToHtml
                              ,main: main};
};
