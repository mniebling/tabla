...
Elm.Main.make = function (_elm) {
   ...
   var main = rhythmToHtml(teenTalTheka);
   return _elm.Main.values = {_op: _op,teenTalTheka: teenTalTheka,vibhagToLiElement: vibhagToLiElement,rhythmToHtml: rhythmToHtml,main: main};
};
